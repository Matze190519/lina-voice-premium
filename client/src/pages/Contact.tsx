      ...
      <section className="container mx-auto px-4 -mt-10 relative z-20">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <PremiumCard className="glass-card border-white/10 bg-deep-navy/50 backdrop-blur-xl">
              <CardHeader>
          ...
          <div className="lg:col-span-2">
            <PremiumCard className="glass-card border-white/10 bg-deep-navy/50 backdrop-blur-xl h-full">
              <CardHeader>
