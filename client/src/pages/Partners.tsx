...
import { Check, Users, TrendingUp, ShieldCheck, Rocket, Globe, Play } from "lucide-react";
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                ...
                className="inline-flex items-center px-4 py-2 rounded-sm bg-white/10 hover:bg-white/20 text-white text-sm font-medium transition-colors border border-white/20"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center px-4 py-2 rounded-sm bg-transparent hover:bg-white/10 text-white text-sm font-medium transition-colors border border-white/20"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <PremiumCard>
                ...
                <h3 className="font-heading text-2xl font-bold mb-2 text-white">Attraktive Margen</h3>
            ...
            <PremiumCard>
                ...
                <h3 className="font-heading text-2xl font-bold mb-2 text-white">Exklusive Technologie</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <PremiumCard>
                ...
                <h3 className="font-heading text-2xl font-bold mb-2 text-white">Full-Service Support</h3>
                <p className="text-muted-foreground leading-relaxed">
...
<PremiumCard className="p-8 rounded-2xl">
                ...
                <h3 className="text-2xl font-heading font-bold mb-6 text-white">Partner Benefits</h3>
